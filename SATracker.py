...
def noise_reduction():
    ...
    if i >= 3:
        ...
        Median_Cal_X.append(new_interpolated_list[i - 3][0])
        Median_Cal_X.append(new_interpolated_list[i - 2][0])
        Median_Cal_X.append(new_interpolated_list[i - 1][0])

        # add Y-coordinate of 3 sequential gaze positions into the special list (median calculation for Y)
        Median_Cal_Y.append(new_interpolated_list[i - 3][1])
        Median_Cal_Y.append(new_interpolated_list[i - 2][1])
        Median_Cal_Y.append(new_interpolated_list[i - 1][1])
        ...
        # create list for the median position [x,y,t]
        gaze_point_2d = [median_x, median_y, new_interpolated_list[i - 2][2]]
        ...
        # calculate the velocity of the median point, which is already in the gaze point list
        # velocity_calculator(gaze_point_3D_list)
